...
const DoctorVerificationPage: React.FC<DoctorVerificationPageProps> = ({ doctors }) => {
  ...
  return (
    <div className="flex justify-center items-center mt-10">
      <div className="max-w-lg w-full bg-gray-100 p-8 rounded-lg shadow-lg">
        <h2 className="text-2xl font-bold text-center mb-4">Doctor Serial Number: {serialNumber}</h2>
