...
const DoctorStatusPage = () => {
  ...
  useEffect(() => {
    const fetchDepartments = async () => {
      try {
        ...
        showToast(
          "Oops! Something went wrong while fetching departments",
          "error"
        );
      }
    };
  ...
  return (
    <div className="flex items-center justify-center mb-16 mt-16">
      <div className="bg-gray-100 shadow-xl rounded-md p-12 md:w-4/12 w-full hover:bg-gray-200 hover:shadow-2xl transition duration-300">
        ...
        {formData.status === "rejected" && (
          <button
            className="bg-fuchsia-800 text-white rounded-md px-4 py-2 mt-4"
      ...
      {isModalOpen && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
          <div className="bg-white shadow-md rounded-md p-6 w-full max-w-lg mx-4 my-20 overflow-auto max-h-full">
            {/* Modal content */}
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="flex justify-end">
                <button
                  type="submit"
                  className="bg-fuchsia-800 text-white rounded-md px-4 py-2"
                >
                  Apply
                </button>
                <button
                  type="button"
                  className="text-sm text-fuchsia-800 hover:underline mt-2 ml-2"
