  ...
  return (
    <>
      ...
      <tr className="bg-white border-b dark:bg-white dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-fuchsia-200">
        <td className="px-6 py-4 text-left font-medium text-gray-900 whitespace-nowrap dark:text-gray-900 truncate" style={{ maxWidth: '50px' }}>
          {serialNo}
        </td>
        ...
        <td className="px-6 py-4 text-left ">
          <label className="flex cursor-pointer select-none items-center ">
            <div className="relative">
              ...
              />
              <div
                className={`box block h-6 w-10 rounded-full  border border-black ${
                  isChecked ? "bg-green-700" : "bg-red-500"
                }`}
              ></div>
              <div
                className={`absolute left-1 top-1 flex h-4 w-4 items-center justify-center  rounded-full bg-black transition ${
