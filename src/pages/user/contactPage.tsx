...
import contact from '../../assets/images/icon3_0000_.jpg';
import aboutimg from '../../assets/images/signup.png';
...
const ContactSection: React.FC = () => {
  ...
  const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
    ...
    if (validateForm()) {
      ...
      const serviceId = 'service_px44sli'; // YOUR_SERVICE_ID
      const templateId = 'template_gfpfazr'; // YOUR_TEMPLATE_ID
      const publicKey = 'zDw4TKwDIvW813sgg'; // YOUR_PUBLIC_KEY
              ...
              <form id="form" method="post" role="form" className="php-email-form w-full" onSubmit={handleSubmit}>
                <div className="grid grid-cols-1 gap-4">
                  ...
                  <div className="text-center">
                    <button
                      type="submit"
                      className="button button-a button-big button-rounded form-color m-4 bg-fuchsia-900 hover:bg-fuchsia-600 text-white p-2 rounded-md"
        ...
        <div className="absolute inset-0 bg-gray-200">
          <div className="absolute inset-0 flex items-center justify-between px-20 mx-20">
            <div className="max-w-max">
              <h1 className="text-6xl font-medium text-fuchsia-900 b-10">Contact MediBuddy</h1>
